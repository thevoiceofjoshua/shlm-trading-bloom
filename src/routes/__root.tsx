  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-2xl text-center">
        ...
        {/* TEMP DEBUG START */}
        <pre className="mt-6 max-h-96 overflow-auto whitespace-pre-wrap break-words rounded-md border border-input bg-accent p-4 text-left text-xs text-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@shlmtrading" },
    ],
    links: [
      {
        rel: "stylesheet",
